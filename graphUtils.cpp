// #include "project.h"
//
// int maxNLink = 0, maxSourceCap = 0, maxSinkCap = 0, minNLink = INT_MAX, minSourceCap = INT_MAX, minSinkCap = INT_MAX;
// int minSourceCapI, maxSourceCapI;
//
// int nLinkCapacity(unsigned long intensity1, unsigned long intensity2)
// {
//   int result = (int) round(25 * exp(-1.0 * ((signed) (intensity1 - intensity2)) * ((signed) (intensity1 - intensity2)) / (2.0 * MAX_INTENSITY * MAX_INTENSITY)));
//   minNLink = min(minNLink, result);
//   maxNLink = max(maxNLink, result);
//   return result;
// }
//
...
// 	int result = (int) (-100.0 * log(1 - score));
//   if (result < minSourceCap)
//   {
//     minSourceCapI = intensity;
//     minSourceCap = result;
//   }
//   if (result > maxSourceCap)
//   {
//     maxSourceCapI = intensity;
//     maxSourceCap = result;
//   }
//   return result;
// }
...
// 	int result = (int) (-100.0 * log(score));
//   minSinkCap = min(minSinkCap, result);
//   maxSinkCap = max(maxSinkCap, result);
//   return result;
// }
//
...
//   free(slice0);
//   free(slice1);
//   cout << "nLink in [" << minNLink << ", " << maxNLink << "]" << endl;
//   cout << "sourceCap in [" << minSourceCap << ", " << maxSourceCap << "]" << endl;
//   cout << "min sourceCap occurs at intensity " << minSourceCapI << "; max at " << maxSourceCapI << endl;
//   cout << "sinkCap in [" << minSinkCap << ", " << maxSinkCap << "]" << endl;
//   cout << "max intensity is " << maxIntensity << " and occurs at " << maxIX << ", " << maxIY << ", " << maxIZ << endl;
//   cout << "min intensity is " << minIntensity << " and occurs at " << minIX << ", " << minIY << ", " << minIZ << endl;
//   return g;
// }
